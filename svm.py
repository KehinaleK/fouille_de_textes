...
def matrice_de_confusion(test_evaluation, test_corpus, regime):
    ...
    sns.heatmap(matrice, square=True, annot=True, fmt='d',cmap='OrRd', cbar=True, xticklabels=[f'non-{regime}', regime], yticklabels=[f'non-{regime}', regime])
